    ...
    <div className="navbar">
      ...
      <div className="nav-bottom">
            ...
            >
              ...
              {isDropdownOpen && (
                <ul className="dropdown-menu">
                  <li>
                    <Link to="/necklace" className="dropdown-item">
                      Necklace
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/bracelet" className="dropdown-item">
                      Bracelet
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/under-5k" className="dropdown-item">
                      Under 5k
                    </Link>
                  </li>
                  <li>
                    <Link to="/style" className="dropdown-item">
                      Style
                    </Link>
                  </li>
                </ul>
        ...
        <div className="nav-right">
          ...
          <Link to="/cart">
            <img src={cart_icon} className="nav-cart" alt="Cart" />
          </Link>
